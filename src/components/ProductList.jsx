...
const ProductList = ({ products, onSelectProduct }) => {
  return (
    <div className="w-[512px] h-[748px] p-[0px_32px_0px_32px] gap-[24px] overflow-x-hidden overflow-y-auto custom-scrollbar">
      {products.map((product) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* Star rating tag */}
              <div className="absolute bottom-2 left-2 bg-[#F9FAFB] text-black border border-[#d1d1d2] rounded-tl-full text-xs font-semibold py-1 px-2 rounded-full flex items-center">
            ...
            <div className="mt-0">
              ...
              <p className="text-lg font-semibold text-[18px] leading-[28px]">
                {product.name}
              </p>
              <p className="text-sm text-[#475467] text-[16px] leading-[24px]">
                {product.description}
              </p>
